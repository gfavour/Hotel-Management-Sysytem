...
setInterval(function(){
$.ajax({url:"../fxn/process1.php?dwat=getBar2WaiterAlert",crossOrigin: true,success:function(r){ if(r){ $(".floatalert").fadeIn().html(r).delay(5000).slideUp(200); } },error:function(e){ }});
},10000);
