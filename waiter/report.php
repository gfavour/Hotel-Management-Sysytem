...
<div class="row">
		...
		<div id="msgbox"></div>
              ...
              <h3 class="box-title"><?php if ($_REQUEST["ispaid"] == '0'){echo 'Unpaid';}else if ($_REQUEST["ispaid"] == '1'){echo 'Paid';} echo ucwords($_GET["service"]).' Service'; ?> Financial Report Between <?php echo $_REQUEST["datefrom"].' '.hr24to12($_REQUEST["timefrom"]).' - '.$_REQUEST["dateto"].' '.hr24to12($_REQUEST["timeto"]); ?></h3>
			...
			<!--box-header -->
				...
				<div class="box-body table-responsive no-padding" style="margin-top:10px;">
				  ...
				  if ($_REQUEST["ispaid"] == '2'){$filter_ispaid = " ";}
				  		...
				  		if ($_GET["service"] == 'all'){
							$filter_ispaid = " ispaid = '".mysqli_escape_string($conn4as,$_GET["ispaid"])."' AND ";
						
						}elseif ($_GET["service"] == 'room'){
							$filter_ispaid = " ispaid = '".mysqli_escape_string($conn4as,$_GET["ispaid"])."' AND ";
						
						}elseif ($_GET["service"] == 'bar'){
							$filter_ispaid = " order_bar.ispaid = '".mysqli_escape_string($conn4as,$_GET["ispaid"])."' AND ";
						
						}elseif ($_GET["service"] == 'bar2'){
							$filter_ispaid = " order_bar2.ispaid = '".mysqli_escape_string($conn4as,$_GET["ispaid"])."' AND ";
						
						}elseif ($_GET["service"] == 'restaurant'){
							$filter_ispaid = " order_restaurant.ispaid = '".mysqli_escape_string($conn4as,$_GET["ispaid"])."' AND ";
				  ...
				  if ($_REQUEST["staffid"] != ''){
				  		if ($_GET["service"] == 'all'){
							...
							$filter_staff = " order_room.staffid = '".mysqli_escape_string($conn4as,$_GET["staffid"])."' AND ";					
						}elseif ($_GET["service"] == 'bar'){
							$filter_staff = " order_bar.staffid = '".mysqli_escape_string($conn4as,$_GET["staffid"])."' AND ";
						}elseif ($_GET["service"] == 'bar2'){
							$filter_staff = " order_bar2.staffid = '".mysqli_escape_string($conn4as,$_GET["staffid"])."' AND ";
						}elseif ($_GET["service"] == 'restaurant'){
							$filter_staff = " order_restaurant.staffid = '".mysqli_escape_string($conn4as,$_GET["staffid"])."' AND ";
						}elseif ($_GET["service"] == 'spa'){
							$filter_staff = " order_spa.staffid = '".mysqli_escape_string($conn4as,$_GET["staffid"])."' AND ";
						}elseif ($_GET["service"] == 'swimpool'){
							$filter_staff = " order_swimpool.staffid = '".mysqli_escape_string($conn4as,$_GET["staffid"])."' AND ";
						}elseif ($_GET["service"] == 'laundary'){
							$filter_staff = " order_laundary.staffid = '".mysqli_escape_string($conn4as,$_GET["staffid"])."' AND ";
						}elseif ($_GET["service"] == 'sport'){
							$filter_staff = " order_sportitem.staffid = '".mysqli_escape_string($conn4as,$_GET["staffid"])."' AND ";
						}
				  }else{
				  		$filter_staff = " ";
				  }
				  ...
				  if ($_REQUEST["timefrom"] != '' && $_REQUEST["timeto"] != ''){
						...
						if ($_GET["service"] == 'all'){
				  		$filter_dt = " TIMESTAMP(orderdate, ordertime) BETWEEN TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["datefrom"])."','".mysqli_escape_string($conn4as,$_REQUEST["timefrom"])."') AND TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["dateto"])."','".mysqli_escape_string($conn4as,$_REQUEST["timeto"])."') ";
							...
							$filter_dt = " TIMESTAMP(order_room.orderdate, order_room.ordertime) BETWEEN TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["datefrom"])."','".mysqli_escape_string($conn4as,$_REQUEST["timefrom"])."') AND TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["dateto"])."','".mysqli_escape_string($conn4as,$_REQUEST["timeto"])."') ";
										
						}elseif ($_GET["service"] == 'bar'){
							$filter_dt = " TIMESTAMP(order_bar.orderdate, order_bar.ordertime) BETWEEN TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["datefrom"])."','".mysqli_escape_string($conn4as,$_REQUEST["timefrom"])."') AND TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["dateto"])."','".mysqli_escape_string($conn4as,$_REQUEST["timeto"])."') ";
							
						}elseif ($_GET["service"] == 'bar2'){
							$filter_dt = " TIMESTAMP(order_bar2.orderdate, order_bar2.ordertime) BETWEEN TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["datefrom"])."','".mysqli_escape_string($conn4as,$_REQUEST["timefrom"])."') AND TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["dateto"])."','".mysqli_escape_string($conn4as,$_REQUEST["timeto"])."') ";
						
						}elseif ($_GET["service"] == 'restaurant'){
							$filter_dt = " TIMESTAMP(order_restaurant.orderdate, order_restaurant.ordertime) BETWEEN TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["datefrom"])."','".mysqli_escape_string($conn4as,$_REQUEST["timefrom"])."') AND TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["dateto"])."','".mysqli_escape_string($conn4as,$_REQUEST["timeto"])."') ";
							
						}elseif ($_GET["service"] == 'spa'){
							$filter_dt = " TIMESTAMP(order_spa.orderdate, order_spa.ordertime) BETWEEN TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["datefrom"])."','".mysqli_escape_string($conn4as,$_REQUEST["timefrom"])."') AND TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["dateto"])."','".mysqli_escape_string($conn4as,$_REQUEST["timeto"])."') ";
							
						}elseif ($_GET["service"] == 'swimpool'){
							$filter_dt = " TIMESTAMP(order_swimpool.orderdate, order_swimpool.ordertime) BETWEEN TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["datefrom"])."','".mysqli_escape_string($conn4as,$_REQUEST["timefrom"])."') AND TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["dateto"])."','".mysqli_escape_string($conn4as,$_REQUEST["timeto"])."') ";
							
						}elseif ($_GET["service"] == 'laundary'){
							$filter_dt = " TIMESTAMP(order_laundary.orderdate, order_laundary.ordertime) BETWEEN TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["datefrom"])."','".mysqli_escape_string($conn4as,$_REQUEST["timefrom"])."') AND TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["dateto"])."','".mysqli_escape_string($conn4as,$_REQUEST["timeto"])."') ";
							
						}elseif ($_GET["service"] == 'sport'){
							$filter_dt = " TIMESTAMP(order_sportitem.orderdate, order_sportitem.ordertime) BETWEEN TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["datefrom"])."','".mysqli_escape_string($conn4as,$_REQUEST["timefrom"])."') AND TIMESTAMP('".mysqli_escape_string($conn4as,$_REQUEST["dateto"])."','".mysqli_escape_string($conn4as,$_REQUEST["timeto"])."') ";
						}
				  }else{
