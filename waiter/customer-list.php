...
<div class="content-wrapper">
        <!-- Page Header -->
		<?php
		$sql = select("SELECT lastname,firstname FROM addclient WHERE id = ".mysqli_escape_string($conn4as,$_GET["guestid"])." ORDER BY id DESC");
