                ...
                <div class="box-header with-border">
				  ...
				  <div class="box-tools">
					 ...
					 <div class="input-group-btn">
						...
						<a href="add-bar2.php" class="btn btn-primary btn-sm" style="margin-right:10px;"><i class="fa fa-plus"></i> Add Bar Item</a>
						<?php } ?>
			...
			<!--box-header -->
				...
				<div class="box-body table-responsive no-padding" style="margin-top:10px;">
                  <form name="reservation" id="reservation">
					<?php
					if ($_GET["dwat"] == 'search'){
					$sql = select2nav("SELECT count(id) as ctn FROM addbar2 WHERE (name LIKE '%".$_GET["q"]."%') ORDER BY id DESC","SELECT * FROM addbar2 WHERE (name LIKE '%".$_GET["q"]."%') ORDER BY id DESC");
					}else{
					$sql = select2nav("SELECT count(id) as ctn FROM addbar2 ORDER BY id","SELECT * FROM addbar2 ORDER BY id");
					}
					if($sql){
