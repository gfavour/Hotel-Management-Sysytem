...
<input type="hidden" name="dwat" value="wordermbar2code">
...
<div id="sidebarform" class="box" style=" padding:20px;margin:5px 0 0 0;display:none;border:#ccc solid 1px;border-top:#ccc solid 3px; margin-top:10px;background: rgb(238,238,238);
