...
<div class="row">
            <div class="col-xs-12">
  <?php
  if (select("SELECT * FROM addroom WHERE id = ".mysqli_escape_string($conn4as,$_GET["id"]))){
...
<?php
if (select("SELECT * FROM roompictures WHERE roomid = '".mysqli_escape_string($conn4as,$_GET["id"])."' ORDER BY id")){
