            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border-bottom:#fff solid 1px; padding-left:0;">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro"><li><a data-toggle="tab" href="#" onClick="window.location = 'order-res-home.php';" style="background:#fff;" class="<?php echo $active1; ?>"><i class="fa fa-user"></i> Order Item</a>
                        ...
                        <li><a data-toggle="tab" href="#" onClick="window.location = 'order-res-lists.php';" style="background:#fff;" class="<?php echo $active2; ?>"><i class="fa fa-glass"></i> Order Lists</a>                        </li>
                        <!--<li><a data-toggle="tab" href="#" onClick="window.location = 'order-swimpool-lists.php';" style="background:#fff;" class="<?php echo $active3; ?>"><i class="fa fa-table"></i> Laundry Services</a></li>-->
