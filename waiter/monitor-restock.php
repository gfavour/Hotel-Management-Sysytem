			...
			<!--box-header -->
				...
				<div class="box-body table-responsive no-padding" style="margin-top:10px;">
                  <form name="reservation" id="reservation">
					<?php
					if ($_GET["dwat"] == 'search'){
					$sql = select2nav("SELECT count(id) as ctn FROM addbar WHERE (itemleft < 6 AND name LIKE '%".$_GET["q"]."%') ORDER BY id DESC","SELECT * FROM addbar WHERE (itemleft < 6 AND name LIKE '%".$_GET["q"]."%') ORDER BY id DESC");
					}else{
