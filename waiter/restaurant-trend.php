...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Restaurant Trend Analysis <?php if($_GET["month"] != ''){ echo '('.getMonth($_GET["month"]).', '.$_GET["year"].')'; } ?></h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Restaurant Trend Analysis</li>
          </ol>
        </section>
