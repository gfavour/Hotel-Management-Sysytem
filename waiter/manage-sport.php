			...
			<!--box-header -->
				...
				<div class="box-body table-responsive no-padding" style="margin-top:10px;">
                  <form name="reservation" id="reservation">
					<?php
					if ($_GET["dwat"] == 'search'){
					$sql = select2nav("SELECT count(id) as ctn FROM addsport WHERE (name LIKE '%".$_GET["q"]."%') ORDER BY id DESC","SELECT * FROM addsport WHERE (name LIKE '%".$_GET["q"]."%') ORDER BY id DESC");
					}else{
