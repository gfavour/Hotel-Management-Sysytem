...
<div class="row">
            <div class="col-xs-12">
  <?php
  if (select("SELECT * FROM addresturant WHERE id = ".mysqli_escape_string($conn4as,$_GET["id"]))){
...
<textarea name="description" class="form-control" placeholder="Food Description"><?php echo $rs["description"]; ?></textarea>
</div>
</div>

<div class="col-md-12" style="margin-top:10px;">
<button class="btn btn-warning btn-md" style="margin-right:10px;">Update</button> <a href="manage-resturant.php">Back to Manage Restuarant</a>
</div>
</form>
</div>
</div>
