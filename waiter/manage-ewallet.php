...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Guests e-Wallet</h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Guests e-Wallet</li>
          </ol>
        </section>
...
<div class="row">
            <div class="col-xs-8">
              <div style="margin-bottom:10px;">
			   <button class="btn btn-primary btn-sm" style="margin-right:10px;" id="jqbtn1"><i class="fa fa-money"></i> Deposit</button>
              </div>
			...
			<!--box-header -->
				...
				<div class="box-body table-responsive no-padding" style="margin-top:10px;">
                  <form name="reservation" id="reservation">
					<?php
					if ($_GET["dwat"] == 'search'){
					$sql = select2nav("SELECT count(id) as ctn FROM addclient WHERE (lastname LIKE '%".$_GET["q"]."%' OR firstname LIKE '%".$_GET["q"]."%' OR phone LIKE '%".$_GET["q"]."%') ORDER BY id","SELECT * FROM addclient WHERE (lastname LIKE '%".$_GET["q"]."%' OR firstname LIKE '%".$_GET["q"]."%' OR phone LIKE '%".$_GET["q"]."%') ORDER BY id");
					}else{
