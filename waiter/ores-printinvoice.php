...
<body>
    ...
    <div>
		...
		$qry = mysqli_query($conn4as,"SELECT id,invoiceid,guestid,ispaid FROM order_restaurant WHERE invoiceid = '".mysqli_escape_string($conn4as,$_GET["invoiceid"])."' ORDER BY id DESC");
