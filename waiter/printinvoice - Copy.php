			  ...
			  <div class="box">
                <div class="box-header with-border">
				  ...
				  <div class="box-tools">
					 ...
					 <a href="invoice-pos.php?printer=pos&invoiceid=<?php echo $_GET["invoiceid"]; ?>" target="_blank" class="btn btn-sm btn-primary" style="margin-right:10px;">Send to POS Printer</a> <a href="invoice.php?printer=desktop&invoiceid=<?php echo $_GET["invoiceid"]; ?>" target="_blank" class="btn btn-sm btn-primary" style="margin-right:10px;">Send to Desktop Printer</a> <?php echo $ispaid.$checkstatusbtn; ?>
					 </div>
