...
<div class="row">
            <div class="col-xs-12">
  <?php
  if (select("SELECT * FROM addswimpool WHERE id = ".mysqli_real_escape_string($conn4as,$_GET["id"]))){
...
<button class="btn btn-warning btn-md" style="margin-right:10px;">Update</button> <a href="manage-swimpool.php" class="btn btn-md btn-default">Back to Swimming Pool</a>
</div>
</form>
</div>
</div>
