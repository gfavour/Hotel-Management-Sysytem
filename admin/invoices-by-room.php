...
$qry = mysqli_query($conn4as,"SELECT roomType FROM addroom WHERE id = ".mysqli_real_escape_string($conn4as,$_GET["room"]));
...
if ($globalrole == 'admin' || $globalrole == 'manager' || $globalrole == 'receptionist'){ 
	...
	$showall = " AND (orders.isbar = '1' OR orders.isbar2 = '1' OR orders.isbar3 = '1' OR orders.isswimpool = '1') ";
	$showall2 = " WHERE (orders.isbar = '1' OR orders.isbar2 = '1' OR orders.isbar3 = '1' OR orders.isswimpool = '1') ";
