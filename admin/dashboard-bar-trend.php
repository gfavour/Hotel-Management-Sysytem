					...
					if($sql){		
						echo '<div class="col-sm-12" style="margin-top:10px;margin-bottom:20px; background:#fff; padding:10px; border-radius:5px;"><canvas id="mybarChart"></canvas></div>';		  					  
						...
						if($odate != ''){ $clbl = 'Bar-1 Trend Analysis ('.getMonth($_GET["month"]).', '.$_GET["year"].')'; }else{ $clbl = 'Bar-1 Trend Analysis'; }
