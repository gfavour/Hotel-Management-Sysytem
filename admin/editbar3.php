...
<input type="hidden" name="dwat" value="editbar3" />
...
<a href="manage-bar3.php" class="btn btn-sm btn-default" style="margin-right:10px;">Go Back</a><button class="btn btn-warning btn-sm">Update</button>
</div>
