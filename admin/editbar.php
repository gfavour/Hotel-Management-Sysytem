...
<input type="hidden" name="dwat" value="editbar" />
...
<div class="form-group input-group">
<span class="input-group-addon"><i class="fa fa-envelope-o"></i></span>
<input type="text" name="price" class="form-control" placeholder="Selling Price" value="<?php echo $rs["price"]; ?>">
</div>
</div>
...
<a href="manage-bar.php" class="btn btn-sm btn-default" style="margin-right:10px;">Go Back</a><button class="btn btn-warning btn-sm">Update</button>
</div>
