...
<select name="guest" id="guest" title="Customer" class="form-control selectpicker" data-live-search="true">
<?php
  if(select("SELECT id,lastname,firstname FROM addclient WHERE id <> '1' ORDER BY lastname")){
...
<button type="button" class="btn btn-warning btn-md" style="margin-right:10px;" name="cmdsubmit" id="cmdsubmit"><i class="fa fa-send"></i> Submit</button>
</div>
</form>
</div>
</div>