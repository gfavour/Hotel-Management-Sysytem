...
<body>
    ...
    <div class="row" style="padding:0px;">
		...
		$qry = mysqli_query($conn4as,"SELECT id,invoiceid,guestid,ispaid FROM order_bar2 WHERE invoiceid = '".mysqli_real_escape_string($conn4as,$_GET["invoiceid"])."' ORDER BY id DESC");
