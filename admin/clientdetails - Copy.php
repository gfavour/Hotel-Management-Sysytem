...
<h3><?php echo 'Invoice #'.$invoiceid; ?></h3><!--<strong style="color:#f00;">Please Note:</strong> If you are checking out customer with unpaid invoice, make sure you <strong>print out the unpaid invoice (receipt)</strong> for future reference.-->
</div>
