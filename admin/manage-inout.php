...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Booking Transactions</h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Booking Transactions</li>
          </ol>
        </section>
				...
				<div class="box-body table-responsive no-padding" style="margin-top:10px;">
				  ...
				  echo '<table class="table table-striped"><tr>
					...
					while($rs = mysqli_fetch_assoc($qry)){
					   ...
					   if ($rs["ispaid"] == '1'){$ispaid1 = '<span class="label label-success">Paid</span>'; $ispaid = '<a href="javascript:;" class="btn btn-xs btn-warning" style="margin-right:10px;" onclick="dopay(\'unpaid\',\'invoiceid='.$rs["invoiceid"].'&s=dounpaid&dwat=paidunpaid\',\'../fxn/process1.php\',\'\')">Mark As UnPaid</a>';}else{$ispaid1 = '<span class="label label-warning">Unpaid</span>'; $ispaid = '<a href="javascript:;" class="btn btn-xs btn-warning" style="margin-right:10px;" onclick="dopay(\'paid\',\'invoiceid='.$rs["invoiceid"].'&s=dopaid&dwat=paidunpaid\',\'../fxn/process1.php\',\'\')">Mark As Paid</a>';}
						
						if ($rs["checkstatus"] == 'in'){$checkedstatus = '<a href="javascript:;" class="btn btn-xs btn-warning" style="margin-right:10px;" onclick="docheck(\'out\',\'invoiceid='.$rs["invoiceid"].'&id='.$rs["id"].'&roomid='.$rs["roomid"].'&s=out&dwat=doinout\',\'../fxn/process1.php\',\'\')" title="Invoiceid: '.$rs["invoiceid"].', Order id:'.$rs["id"].', Roomid: '.$rs["roomid"].'">Check Out</a>';}elseif($rs["checkstatus"] == ''){ $checkedstatus = '';
						}
						...
						echo '<td>'.$ispaid1.'</td>';
						//echo '<td><a href="clientdetails.php?roomid='.$rs["roomid"].'&invoiceid='.$rs["invoiceid"].'" class="label label-primary">Receipt</a></td>';
						echo '</tr>';
						$checkedstatus = '';
						$ispaid1 = '';
						$ispaid = '';
