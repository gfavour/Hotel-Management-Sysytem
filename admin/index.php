...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            DASHBOARD (<?php echo $strthismonth; ?>)
            </h1>
          <ol class="breadcrumb">
...
<div class="row">
            ...
            <div class="col-lg-3 col-xs-6" onclick="window.location.href='<?php echo ($globalrole == 'admin' || $globalrole == 'manager' || $globalrole == 'receiptionist')?'manage-inout-grid.php':'#'; ?>';" style="cursor:pointer;display:none;">
              <!-- small box -->
              <div class="small-box bg-red">
                <div class="inner">
                  <h3><?php //echo returnField("SELECT count(id) AS ctn FROM addroom WHERE currentinv <> ''","ctn"); ?></h3>
                  <p>Room Booked</p>
                </div>
                <div class="icon">
                  <i class="fa fa-building"></i>
			...
			<?php if($globalrole == 'admin' || $globalrole == 'manager'){ ?>
 			<div class="col-lg-3 col-xs-6" onclick="window.location.href='bar-trend.php';" style="cursor:pointer;">
              <div class="small-box bg-aqua">
                <div class="inner">
                   <h3><sup style="font-size: 20px"><?php echo $sign; ?></sup><?php echo number_format(returnField("select sum(total) as bartotal from order_bar where DATE_FORMAT(orderdate,'%Y-%m' ) = '".mysqli_real_escape_string($conn4as,$thismonth)."'","bartotal"),2); ?></h3>
                  <p>Bar-1 Revenue</p>
                </div>
                <div class="icon">
			...
			<div class="col-lg-3 col-xs-6" onclick="window.location.href='bar2-trend.php';" style="cursor:pointer;">
              <div class="small-box bg-purple">
                <div class="inner">
                   <h3><sup style="font-size: 20px"><?php echo $sign; ?></sup><?php echo number_format(returnField("select sum(total) as bar2total from order_bar2 where DATE_FORMAT(orderdate,'%Y-%m') = '".mysqli_real_escape_string($conn4as,$thismonth)."'","bar2total"),2); ?></h3>
                  <p>Bar-2 Revenue</p>
                </div>
                <div class="icon">
                  <i class="fa fa-glass"></i>
			...
			<div class="col-lg-3 col-xs-6" onclick="window.location.href='bar3-trend.php';" style="cursor:pointer;">
              <div class="small-box bg-orange">
                <div class="inner">
                   <h3><sup style="font-size: 20px"><?php echo $sign; ?></sup><?php echo number_format(returnField("select sum(total) as bar3total from order_bar3 where DATE_FORMAT(orderdate,'%Y-%m') = '".mysqli_real_escape_string($conn4as,$thismonth)."'","bar3total"),2); ?></h3>
                  <p>Bar-3 Revenue</p>
                </div>
                <div class="icon">
                  <i class="fa fa-glass"></i>
			...
			<div class="col-lg-3 col-xs-6" onclick="window.location.href='restaurant-trend.php';" style="cursor:pointer;">
              ...
              <div class="small-box bg-green">
                <div class="inner">
                  <h3><sup style="font-size: 20px"><?php echo $sign; ?></sup><?php echo number_format(returnField("select sum(total) as restotal from order_restaurant where DATE_FORMAT(orderdate,'%Y-%m') = '".mysqli_real_escape_string($conn4as,$thismonth)."'","restotal"),2);?></h3>
            ...
            <div class="col-lg-3 col-xs-6" onclick="window.location.href='rooms-trend.php';" style="cursor:pointer;">
              ...
              <div class="small-box bg-yellow">
                <div class="inner">
                  <h3><sup style="font-size: 20px"><?php echo $sign; ?></sup><?php echo number_format(returnField("SELECT SUM(total) AS rmtotal FROM order_room WHERE DATE_FORMAT(orderdate,'%Y-%m') = '".mysqli_real_escape_string($conn4as,$thismonth)."'","rmtotal"),2); ?></h3>
                  <p>Room Revenue</p>
                </div>
                <div class="icon">
                  <i class="fa fa-table"></i>
         ...
         <!--Start Trending--->
    <div class="col-lg-12">
		 <div class="col-lg-6" style="padding-left:0px;"><?php include("dashboard-room-trend.php"); ?></div>
		 <div class="col-lg-6" style="padding-left:0px;"><?php include("dashboard-bar-trend.php"); ?></div>
		 <div class="col-lg-6" style="padding-left:0px;"><?php include("dashboard-bar2-trend.php"); ?></div>
		 <div class="col-lg-6" style="padding-left:0px;"><?php include("dashboard-bar3-trend.php"); ?></div>     
		 </div>
		 <!--End Trending--->
               <br clear="all" />
                ...
                <div class="box-body">
                  <div class="table-responsive">
                    <table class="table no-margin">
					  ...
					  }else if ($globalrole == 'bar3'){
					  $sql = select("SELECT orders.*,addclient.lastname,addclient.firstname FROM orders INNER JOIN addclient ON orders.guestid = addclient.id WHERE orders.isbar3 = '1' ORDER BY orders.id DESC LIMIT 10");
...
<style>
.inner h3{ font-size:26px; margin-bottom:30px;}
.inner h3 sup{ font-size:16px !important;}
</style>