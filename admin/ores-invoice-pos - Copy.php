				...
				<div style="margin-top:1px;">
				  <?php
					...
					while($rs = mysqli_fetch_assoc($qry)){						
						...
						echo '<strong>Qty: </strong>'.$rs["qty"].', <strong>Price: </strong>'.$cursign.$rs["unitprice"].$sclabel.'<br><strong>Discount: </strong>'.number_format($rs["discount"],4).'%<br><strong>Total: </strong>'.$cursign.number_format($rs["total"],2);
