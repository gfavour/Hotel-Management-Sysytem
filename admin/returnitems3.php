...
<body>
	...
	<div class="box box-primary">
			        <?php
					$sql = select("SELECT order_bar3.*,addbar3.name FROM order_bar3 inner join addbar3 on order_bar3.itemid = addbar3.id WHERE order_bar3.invoiceid = '".mysqli_escape_string($conn4as,$_GET["invoiceid"])."' ORDER BY order_bar3.id");
					if($sql){
