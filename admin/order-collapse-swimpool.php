...
<div class="col-sm-4">
  ...
  <span class="input-group-addon"><i class="fa fa-table"></i></span>
   <select name="swimpoolitem" id="swimpoolitem" title="room_type" onchange="getOptions(this,'swimpoolDetails','<?php echo '../fxn/process1.php'; ?>')" class=" form-control">
...
<div class="col-sm-4">
  ...
  <div class="form-group input-group">  
 <input type="number" step="any" class="form-control" placeholder="" value="0" name="swimpooldiscount" id="swimpooldiscount" onchange="calculateswimpool()" onkeyup="calculateswimpool()">
