...
<?php
	$isopenshift = 0;
	$qrys = mysqli_query($conn4as,"SELECT * FROM tblshifts WHERE servicetype = 'bar3' ORDER BY id DESC LIMIT 1");
...
<div class="header-top-area">
        <div class="container" style="padding:0;">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="padding:0;">
                    <div class="logo-area">
                        <a href="#" style="font-size:1.8em;font-weight:600;color:#fff !important;">HOTEL BAR 3<!--<img src="resource/img/logo/logo.png" alt="" />--></a>
                    </div>
                </div>
	...
	<div style="font-size:28px; padding-bottom:10px;">Use the button below to Open/Close Shift, or Logout.</div>
				<button id="openshiftbtn" type="button" onclick="SendByAjax('dwat=openshift&stype=bar3&uid=<?php echo $globalid; ?>','../fxn/processshift.php','')" class="btn btn-lg btn-info" style="display:block;margin:0 auto 10px auto;width:300px;">OPEN SHIFT</button>
				<button id="closeshiftbtn" type="button" class="btn btn-lg btn-warning" style="display:block;margin:0 auto 10px auto;width:300px;display:none;" onclick="SendByAjax('dwat=closeshift&stype=bar3&uid=<?php echo $globalid; ?>','../fxn/processshift.php','')">CLOSE SHIFT & LOGOUT</button>
