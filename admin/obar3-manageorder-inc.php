...
<div id="containeritems">              
  <?php
  $sql = "SELECT * FROM addbar3 ORDER BY name";
  ...
  echo '<input type="checkbox" id="barcheck-'.$rs["id"].'" name="barcheck[]" value="'.$rs["id"].'" style="position:absolute; width:10px; height:10px;margin-top:-20px;" onclick="calculatembar()">';
