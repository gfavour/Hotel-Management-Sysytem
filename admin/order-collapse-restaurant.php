  ...
  <option value="0">Choose a food</option>
    <?php
			  ...
			  while($rs = mysqli_fetch_assoc($query)){
                echo '<option value="'.$rs['id'].'">'.$rs['name'].' ('.getOneField("SELECT catname FROM tblcategory WHERE id = ".mysqli_real_escape_string($conn4as,$rs["categoryid"]),"catname").')</option>';
			  }
			  ?>
  </select>
  </div>
...
<div class="col-sm-4">
 ...
 <input type="number" step="any" class="form-control" placeholder="" value="0" name="resdiscount" id="resdiscount" onchange="calculateres()" onkeyup="calculateres()">
 <span class="input-group-addon styledc"<?php echo DiscountConversion4Res(); ?>><i class="fa fa-building-o"></i></span>
  </div>
</div>
