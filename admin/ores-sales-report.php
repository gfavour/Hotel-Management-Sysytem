...
$paidtotal = getGrandTotal("SELECT SUM(order_restaurant.total) AS grandtotal FROM order_restaurant WHERE order_restaurant.ispaid = '1' AND ".$filter_qry." ORDER BY id");
$unpaidtotal = getGrandTotal("SELECT SUM(order_restaurant.total) AS grandtotal FROM order_restaurant WHERE order_restaurant.ispaid <> '1' AND ".$filter_qry." ORDER BY id");
