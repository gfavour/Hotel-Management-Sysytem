...
if($pagelnk == 'order-bar3-home' || $pagelnk == 'order-res-home'){
  $active1 = 'active';
}elseif($pagelnk == 'order-bar3-lists' || $pagelnk == 'order-res-lists'){
  $active2 = 'active';
}elseif($pagelnk == 'order-bar3-spool' || $pagelnk == 'order-swimpool-lists2'){
  $active3 = 'active';
}elseif($pagelnk == 'order-bar-waiter-lists' || $pagelnk == 'order-bar3-waiter-lists'){
  $active3a = 'active';
}elseif($pagelnk == 'bar3-sales-report'){
  $active4a = 'active';
}elseif($pagelnk == 'obar3-request'){
  $active4b = 'active';
}
if ($globalrole != 'admin' && $globalrole != 'manager' && $globalrole != 'bar3'){
