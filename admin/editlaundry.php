...
<div class="row">
            <div class="col-xs-12">
  <?php
  if (select("SELECT * FROM addlaundary WHERE id = ".mysqli_real_escape_string($conn4as,$_GET["id"]))){
...
<button class="btn btn-warning btn-md" style="margin-right:10px;">Update</button> <a href="manage-laundry.php" class="btn btn-default btn-md">Back to Manage Laundry</a>
</div>
</form>
</div>
</div>
