...
if($pagelnk == 'order-bar2-home' || $pagelnk == 'order-res-home'){
  $active1 = 'active';
}elseif($pagelnk == 'order-bar2-lists' || $pagelnk == 'order-res-lists'){
  $active2 = 'active';
}elseif($pagelnk == 'order-bar2-spool' || $pagelnk == 'order-swimpool-lists2'){
  $active3 = 'active';
}elseif($pagelnk == 'order-bar-waiter-lists' || $pagelnk == 'order-bar2-waiter-lists'){
  $active3a = 'active';
}elseif($pagelnk == 'bar2-sales-report'){
  $active4a = 'active';
}elseif($pagelnk == 'obar2-request'){
  $active4b = 'active';
}
if ($globalrole != 'admin' && $globalrole != 'manager' && $globalrole != 'bar2'){
