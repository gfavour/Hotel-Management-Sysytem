...
<div class="col-sm-4">
 ...
 <input type="number" step="any" class="form-control" placeholder="" value="0" name="spodiscount" id="spodiscount" onchange="calculatespo()" onkeyup="calculatespo()">
 <span class="input-group-addon styledc"<?php echo DiscountConversion4Spo(); ?>><i class="fa fa-building-o"></i></span>
  </div>
</div>
