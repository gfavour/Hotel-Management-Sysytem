...
<input type="hidden" name="dwat" value="editwallet" />
...
<input type="text" name="lastname" class="form-control" readonly value="<?php echo $rs["lastname"]; ?>">
</div>
</div>
...
<div class="form-group input-group">
<span class="input-group-addon"><i class="fa fa-user"></i></span>
<input type="text" name="firstname" class="form-control" readonly placeholder="firstname" value="<?php echo $rs["firstname"]; ?>">
</div>
</div>
...
<input type="text" name="amount" class="form-control" placeholder="Amount in Wallet" value="<?php echo $rs["amount"]; ?>">
...
<button class="btn btn-warning btn-md" style="margin-left:10px;">Update</button>
</div>
</form>
</div>
</div>
